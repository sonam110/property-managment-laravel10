<div class="card sticky-top" style="top:30px">
    <div class="list-group list-group-flush" id="useradd-sidenav">
        ...
        <a href="{{route('property-type.index')}}" class="list-group-item list-group-item-action border-0 {{ (request()->is('property-type*')  || request()->is('unit-type*')  || request()->is('utility*') ? 'active' : '')}}">{{__('Property')}} <div class="float-end"><i class="ti ti-chevron-right"></i></div></a>

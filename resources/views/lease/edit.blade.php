                                ...
                                @foreach($rentCals as $key=>  $rentc)
                                    <div class="row g-3 textBoxWrapper rent-increment-row"><br>
                                      <div class="col-sm-3">
                                       {{ Form::label('from_month', __('From Month'), ['class' => 'form-label']) }}
                                        {{ Form::number('from_month[]',$rentc->from_month, ['class' => 'form-control from_month','id'=>'from_month','min'=>'1','step'=>'1', 'placeholder' => __('From Month')]) }}
                                        @error('from_month')
                                            <small class="invalid-name" role="alert">
                                                <strong class="text-danger">{{ $message }}</strong>
                                            </small>
                                    ...
                                    <div class="col-sm-3">
                                       {{ Form::label('to_month', __('To Month'), ['class' => 'form-label']) }}
                                        {{ Form::number('to_month[]', $rentc->to_month, ['class' => 'form-control to_month','id'=>'to_month','min'=>'1','step'=>'1','placeholder' => __('To Month')]) }}
                                        @error('to_month')
                                            <small class="invalid-name" role="alert">
                                                <strong class="text-danger">{{ $message }}</strong>
                                            </small>
                                ...
                                @foreach($camCals as $key=>  $rentc)
                                    <div class="row g-3 textBoxWrapper cam-increment-row"><br>
                                       ...
                                       {{ Form::label('cam_from_month', __('From Month'), ['class' => 'form-label']) }}
                                        {{ Form::number('cam_from_month[]',$rentc->from_month, ['class' => 'form-control cam_from_month','id'=>'cam_from_month','min'=>'1','step'=>'1', 'placeholder' => __('From Month')]) }}
                                    ...
                                    <div class="col-sm-3">
                                       {{ Form::label('cam_to_month', __('To Month'), ['class' => 'form-label']) }}
                                        {{ Form::number('cam_to_month[]', $rentc->to_month, ['class' => 'form-control cam_to_month','id'=>'cam_to_month','min'=>'1','step'=>'1','placeholder' => __('To Month')]) }}
                                        @error('cam_to_month')
                                            <small class="invalid-name" role="alert">
                                                <strong class="text-danger">{{ $message }}</strong>
                                            </small>

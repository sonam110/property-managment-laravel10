        ...
        <div class="d-flex col-12 col-lg-5 align-items-center p-4 p-sm-5">
          <div class="w-px-400 mx-auto">
            ...
            <!-- <p class="mb-4">for <span class="fw-medium">john.doe@email.com</span></p> -->
              {{Form::open(array('route'=>'password.update','method'=>'post','id'=>'formAuthentication','class'=>'mb-3'))}}
              <input type="hidden" name="token" value="{{ $request->route('token') }}">
                ...
                <div class="input-group input-group-merge">
                  ...
                  <span class="input-group-text cursor-pointer"><i class="ti ti-email-off"></i></span>

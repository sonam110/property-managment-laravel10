...
<script>
   $(document).ready( function () {
    var userCreateUrl = '{{ route('tenant-utility.create') }}';
    var table = $('.datatables-users').DataTable({
       "processing": true,
       "serverSide": true,
       "ajax":{
           'url' : '{{ route('api.tenant-utility-list') }}',
           'type' : 'POST',
            "data": function(d) {
      ...
      buttons: [
        ...
        },
        {
                ...
                action: function (e, dt, node, config) {
                    var url = '{{ route('tenant-utility.create') }}'; // URL to load modal content
...
$('#property_id, #type').on('change', function(e) {
       table.draw();
   });
});

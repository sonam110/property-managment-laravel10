...
class TenantController extends Controller
{
    public function index()
    {
        ...
        return View('tenant.index',compact('roles','data'));
    }
    ...
    public function create()
    {
        ...
        if (\Auth::user()->can('tenant-add')) {
            return view('tenant.create', compact('roles','countries'));
        } else {
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            DB::commit();
            return redirect()->route('tenants.index')->with('success', __('User successfully created.'));
        } catch (\Throwable $e) {
            \Log::error($e);
            DB::rollback();
     ...
     public function edit($id)
    {
        ...
        if (\Auth::user()->can('tenant-edit')) {
            ...
            return view('tenant.edit', compact('user', 'roles','countries','statsList'));
        } else {
            return redirect()->back();
        }
     ...
     public function destroy($id)
    {
        ...
        if (\Auth::user()->can('tenant-delete')) {
            ...
            if ($user) {
                ...
                $user->delete();
                return redirect()->route('tenants.index')->with('success', __('User successfully deleted .'));
            } else {
